...
void Game::initWindow()
{
    ...
    this->window =new sf::RenderWindow(this->videoMode,"XX",sf::Style::Close);
...
void Game::createball()
{
     if(this->time < this->maxtime)
...

        {
         ...
         {
             this->balls.push_back(Ball(*this->window, this->randomize()));
             this->time=0.f;
         }
     }
...
void Game::updateRabbit()
{
  this->rabbit->update(this->window);
...
this->rabbit->render(*this->window);
